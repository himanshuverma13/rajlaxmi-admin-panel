                        ...
                        <form action="">
                            <div class="card p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="product_description" rows="3" placeholder="Description"
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="number" class="form-control" id="product_price" placeholder="Enter price"
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="number" class="form-control" id="product_stock" placeholder="Enter price"
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="product_category" placeholder="Enter product code"
