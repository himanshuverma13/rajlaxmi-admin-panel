                  ...
                  <div class="row gap-3 p-4">
                    ...
                    <div class="col-lg-5">
                      <div class="shop-content">
                        ...
                        <h4>{CurrentProductDetails?.product_name}</h4>
                        <p class="mb-3">{CurrentProductDetails?.product_description}</p>
                        <h4 class="mb-3">
                       ₹ {CurrentProductDetails?.product_price}
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-8 py-7">
                          ...
                          <div class="fw-bold d-block text-primary p-3">{CurrentProductDetails?.product_category}</div>
                        </div>
                        <div class="d-flex align-items-center justify-content-between gap-8 py-7">
                          <h6 class="mb-0 fs-4">Stock:</h6>
                          <div class="fw-bold d-block text-primary p-3">{CurrentProductDetails?.product_stock}</div>
                        </div>
                        <div class="d-flex align-items-center justify-content-between gap-7 pb-7 mb-7 border-bottom">
                          <h6 class="mb-0 fs-4">QTY:</h6>
                          <div class="fw-bold d-block text-primary p-3">{CurrentProductDetails?.product_quantity}</div>
                        </div>
                        <div class="d-flex align-items-center justify-content-between gap-7 pb-7 mb-7 border-bottom">
                          <h6 class="mb-0 fs-4">Website Name:</h6>
                          <div class="fw-bold d-block text-primary p-3">{CurrentProductDetails?.product_website_name}</div>
                        </div>
